"""P2 Ticket CF — goals label Tháng chi hiện tại."""
...
class TestP2GoalsCoveredVi(unittest.TestCase):
    def test_label(self):
        html = HTML.read_text(encoding="utf-8")
        self.assertIn("line('Tháng chi hiện tại', cur.months_covered)", html)
        self.assertIn("\u00e1", html)
        self.assertIn("\u1ec7", html)
        self.assertIn("\u1ea1", html)
        self.assertNotIn("line('current.months_covered'", html)
        self.assertIn("cur.months_covered", html)
        ...
        self.assertIn("line('Phần trăm', pct(cur.percent))", html)
