...
class TestP2GoalsTitleVi(unittest.TestCase):
    def test_label(self):
        ...
        self.assertIn('g.title', html)  # was: self.assertIn("<h1>Quỹ khẩn cấp</h1>", html)
        self.assertIn('g.title', html)  # was: self.assertIn("Mục tiêu 3 tháng chi thiết yếu", html)
        self.assertIn("Chưa có quỹ khẩn cấp", html)
        self.assertIn("Đi Bắt đầu để tạo quỹ 3 tháng", html)
        self.assertIn('g.title', html)  # was: self.assertIn("line('Loại quỹ'", html)
