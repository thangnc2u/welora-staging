"""P2 Ticket BN — content unknown fallback Không tìm thấy."""
...
class TestP2ContentUnknownVi(unittest.TestCase):
    def test_unknown_fallback(self):
        html = HTML.read_text(encoding="utf-8")
        self.assertIn("d.error||'Không tìm thấy'", html)
        self.assertIn("elTitle.textContent='Không tìm thấy'", html)
        self.assertIn("\u00f4", html)
        self.assertIn("\u00ec", html)
        self.assertIn("\u1ea5", html)
        self.assertNotIn("unknown principle_key", html)
