...
class TestP2SafetyMasteryVi(unittest.TestCase):
    def test_chrome(self):
        ...
        self.assertIn('textContent="Làm chủ · "+(st==="not_started"?"Chưa bắt đầu":st==="learning"?"Đang học":st==="familiar"?"Quen thuộc":st==="apply"?"Áp dụng":st==="mastered"?"Thành thạo":st)', html)
